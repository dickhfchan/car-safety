...
def retrieve_table(query_args, conn, json_format=False):
    ...
    if query_args[0] in ["veh_trip_detail", "veh_trip", "veh_trip_by_driver"]:
        ...
        query = "SELECT a.fullname, a.company_id, a.lang, '' as map, group_id, user_id FROM user_account a, company b where a.company_id = b.company_id and a.username = '%s' and password = '%s' and b.company_code = '%s'"%(query_args[1], query_args[2], query_args[3])
